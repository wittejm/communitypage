...
// Real placeholder content for the 10 most populous counties
const multnomahPosts: Post[] = [
  { id: 'multnomah-1', title: 'FINALLY!!!', preview: 'After 3 years of waiting I finally got my record expunged! I can actually apply for jobs now without that stupid box haunting me. Thank you to everyone who helped!' },
  ...
  { id: 'multnomah-3', title: 'thank you!', preview: 'i dont even know what to say. got my papers today and i cried. thank you.' },
  ...
  { id: 'multnomah-5', title: 'Second chance', preview: 'Just signed a lease on an apartment. They actually approved me. Never thought I\'d see this day. God bless this program.' },
  ...
  { id: 'multnomah-7', title: 'THANK YOU THANK YOU', preview: 'Got approved yesterday! After everything I been through this feels like winning the lottery. Now I can see my kids again without their mom using my record against me.' },
  ...
  { id: 'multnomah-10', title: 'Background check came back clean!', preview: 'First background check since my expungement and it came back totally clean. I almost didn\'t believe it. This actually works!' },
  ...
  { id: 'multnomah-12', title: 'I GOT MY RIGHTS BACK', preview: 'Went to the range today for the first time in 12 years. Got my 2A rights restored along with my expungement. Feels good man.' },
  { id: 'multnomah-13', title: 'New job new life', preview: 'Started my new job today at a hospital. Never thought I\'d be able to work in healthcare with my past. So grateful for this opportunity.' },
  ...
  { id: 'multnomah-15', title: 'Thank you!!!', preview: 'Just wanted to say thank you to everyone who posts here. Reading your stories gave me hope when I needed it most.' },
...
const washingtonPosts: Post[] = [
  { id: 'washington-1', title: 'Finally done!', preview: 'Process took forever but my record is finally clear. Already got two job offers. Don\'t give up!' },
  { id: 'washington-2', title: 'thank you all', preview: 'couldn\'t have done this without the support here. my family is so proud of me.' },
  { id: 'washington-3', title: 'Got approved!', preview: 'Judge signed off on my petition today! I can finally move forward with my life and put the past behind me.' },
  ...
  { id: 'washington-6', title: 'New apartment!', preview: 'Signed a lease today. The background check came back clean and they approved me right away. This is life changing.' },
  { id: 'washington-7', title: 'THANK YOU!!!!', preview: 'I don\'t even have words. After 10 years of being denied housing, denied jobs, denied everything... I\'m finally free.' },
  ...
  { id: 'washington-10', title: 'Second chances are real', preview: 'Started my new career last week. Making more money than I ever have. This program literally saved my life.' },
...
const clackamasPosts: Post[] = [
  { id: 'clackamas-1', title: 'I got a job!', preview: 'After two years of trying, I finally got hired. They ran a background check and it came back clean. I\'m crying happy tears right now!' },
  ...
  { id: 'clackamas-3', title: 'FINALLY APPROVED', preview: 'Judge approved my petition today!!! 8 months of waiting but its DONE. Time to start applying for real jobs.' },
  ...
  { id: 'clackamas-5', title: 'Clean background check!', preview: 'Just got my first clean background check in 15 years. Still can\'t believe it. This process works!' },
  ...
  { id: 'clackamas-8', title: 'Worth the wait', preview: 'Process was slow and frustrating but totally worth it. My life is completely different now. Stay strong everyone.' }
]

const lanePosts: Post[] = [
  { id: 'lane-1', title: 'Thank you Eugene!', preview: 'Local legal aid helped me through the whole process. Record is cleared and I start my new job next week!' },
  ...
  { id: 'lane-3', title: 'New job at UO!', preview: 'Got hired at the University! Background check cleared. Never thought I\'d be able to work at a university with my past.' },
  { id: 'lane-4', title: 'Approved!', preview: 'Judge signed my order today. This is the best day of my life. I can\'t stop smiling!' },
  { id: 'lane-5', title: 'THANK YOU!!!', preview: 'To everyone who helped me - THANK YOU. I got my life back. I got my future back. Forever grateful.' },
...
// All 36 Oregon counties - only the 10 most populous have posts
